    ...
    <table style="padding: 5px" width="100%">
        <tr>
            ...
            <td valign="bottom" align="right" width="50%">
                <font size="3">&nbsp;&nbsp;<strong>欢迎：</strong>${(user.userName)!"sxt"}</font>【${(user.trueName)!"sxt" }】【${(user.roleNames)!"" }】
            </td>
        </tr>
    </table>
</div>
        ...
        <div title="营销管理" data-options="selected:true,iconCls:'icon-yxgl'" style="padding: 10px">
           <#if user_permission?seq_contains("1010")>
            <a href="javascript:openTab('营销机会管理','saleChance/index/1','icon-yxjhgl')" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-yxjhgl'" style="width: 150px">营销机会管理</a>
             ...
             <#if user_permission?seq_contains("1020")>
            <a href="javascript:openTab('客户开发计划','saleChance/index/2','icon-khkfjh')" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-khkfjh'" style="width: 150px">客户开发计划</a>
             </#if>
        </div>
       </#if>
       <#if user_permission?seq_contains("20")>
        <div title="客户管理"  data-options="iconCls:'icon-khgl'" style="padding:10px;">
            <#if user_permission?seq_contains("2010")>
            ...
            <#if user_permission?seq_contains("2020")>
            <a href="javascript:openTab('客户流失管理','customerLoss/index','icon-khlsgl')" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-khlsgl'" style="width: 150px;">客户流失管理</a>
           </#if>
		</div>
         </#if>
        <#if user_permission?seq_contains("30")>
        <div title="服务管理" data-options="iconCls:'icon-fwgl'" style="padding:10px">
         ...
         <#if user_permission?seq_contains("40")>
        ...
        <#if user_permission?seq_contains("50")>
        ...
        <#if user_permission?seq_contains("60")>
